...
static SearchEngine searchengines[] = {
	...
	{ "s", "https://searx.ekabin.xyz/searx/search?q=%s" },
...
static Key keys[] = {
	...
	{ 0,                GDK_KEY_g,      spawn,      BM_SET("_SURF_URI", "_SURF_GO", PROMPT_GO) },
	{ 0,                GDK_KEY_f,      spawn,      SETPROP("_SURF_FIND", "_SURF_FIND", PROMPT_FIND) },
        { 0,                GDK_KEY_b,      spawn,      ADDBMK },
	...
	{ GDK_SHIFT_MASK, GDK_KEY_q,      zoom,       { .i = 0  } },
	...
	{ GDK_SHIFT_MASK, GDK_KEY_p,      print,      { 0 } },
	{ 0,                GDK_KEY_t,      showcert,   { 0 } },

	{ GDK_SHIFT_MASK, GDK_KEY_a,      togglecookiepolicy, { 0 } },
	{ 0,                     GDK_KEY_F11,    togglefullscreen, { 0 } },
	{ GDK_SHIFT_MASK, GDK_KEY_o,      toggleinspector, { 0 } },

	{ MODKEY, GDK_KEY_c,      toggle,     { .i = CaretBrowsing } },
	{ MODKEY, GDK_KEY_f,      toggle,     { .i = FrameFlattening } },
	{ MODKEY, GDK_KEY_g,      toggle,     { .i = Geolocation } },
	{ MODKEY, GDK_KEY_s,      toggle,     { .i = JavaScript } },
	{ MODKEY, GDK_KEY_i,      toggle,     { .i = LoadImages } },
	{ MODKEY, GDK_KEY_b,      toggle,     { .i = ScrollBars } },
	{ MODKEY, GDK_KEY_t,      toggle,     { .i = StrictTLS } },
